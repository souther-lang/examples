...
# property of the root pom is the authority; the Clojure account example's deps.edn and the
# annotation-processor snippet in the README must match it. This is the guardrail against a bump
